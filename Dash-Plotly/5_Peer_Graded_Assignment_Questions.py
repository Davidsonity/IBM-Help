...
Function that takes airline data as input and create 5 dataframes based on the grouping condition
 to be used for plotting charts and graphs.
...
This function takes in airline data and selected year as an input and performs computation for creating charts and 
plots. 
...
@app.callback([Output(component_id='plot1', component_property='children'),
              ...
              # REVIEW4: Holding output state till user enters all the form information.
...
def get_graph(chart, year, children1, children2, c3, c4, c5):
    ...
    if chart == 'OPT1':
        ...
        # Dashboard section Compute required information for creating graph from the data
...
if __name__ == '__main__':
    # REVIEW8: Adding dev_tools_ui=False, dev_tools_props_check=False can prevent error appearing before calling
    # callback function
    app.run_server()
